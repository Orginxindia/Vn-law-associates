...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 md:py-32 relative bg-neutral-950 text-white border-t border-b border-neutral-900 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-amber-500/[0.02] rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-emerald-500/[0.015] rounded-full blur-[120px] pointer-events-none" />

      <div className="max-w-3xl mx-auto px-6 md:px-8 lg:px-12 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-neutral-900 border border-neutral-800 text-amber-400 text-xs font-semibold tracking-wider uppercase mb-6 mx-auto">
          ...
          <h2 className="font-bricolage font-bold text-3xl md:text-4xl lg:text-5xl tracking-tight leading-[1.1] mb-6 text-white">
            Frequently Asked <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-400">Questions</span>
          </h2>
        </div>
        ...
        <div className="space-y-4">
          {FAQ_DATA.map((item, idx) => {
            ...
            return (
              <div 
                key={idx} 
                className={`border border-neutral-800/80 rounded-xl overflow-hidden bg-neutral-900/10 backdrop-blur-sm transition-all duration-300 hover:border-amber-400/30 group ${
                  isActive ? 'border-amber-400/40 bg-neutral-900/25 shadow-lg shadow-amber-500/[0.02]' : ''
                }`}
              >
                {/* Header */}
                <div 
