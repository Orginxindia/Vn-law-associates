...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/4 w-[300px] h-[300px] bg-amber-500/[0.02] rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col">
                <span className="font-bricolage font-semibold text-amber-100 text-base tracking-tight leading-none mb-0.5">VN Law Firm</span>
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-neutral-900 border border-neutral-800">
                ...
                <span className="text-amber-300 text-xs font-medium">Available For Consultation</span>
              </div>
            </div>
          </div>
          <div>
            <h4 className="text-amber-100 font-semibold text-sm mb-3 font-bricolage">Practice Areas</h4>
          ...
          <div>
            <h4 className="text-amber-100 font-semibold text-sm mb-3 font-bricolage">More Services</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-amber-100 font-semibold text-sm mb-3 font-bricolage">Company</h4>
            <ul className="space-y-2">
              {[
