...
export default function Footer() {
  return (
    <motion.footer 
      ...
      className="border-t border-neutral-900 bg-neutral-950 pt-12 pb-6 text-neutral-400 relative overflow-hidden"
    >
      {/* Subtle Background Glow */}
      <div className="absolute bottom-0 left-1/4 w-[300px] h-[300px] bg-white/[0.01] rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div>
            <h4 className="text-white font-semibold text-sm mb-3 font-bricolage">Practice Areas</h4>
            <ul className="space-y-2">
              {['Corporate Law', 'Litigation', 'Criminal Defense', 'Family Law', 'Intellectual Property', 'Immigration'].map((item) => (
                <li key={item}>
                  <a href="#services" className="text-neutral-400 hover:text-white text-sm transition-colors duration-300">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          <div>
            <h4 className="text-white font-semibold text-sm mb-3 font-bricolage">More Services</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-white font-semibold text-sm mb-3 font-bricolage">Company</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={item.label}>
                  <a href={item.href} className="text-neutral-400 hover:text-white text-sm transition-colors duration-300">{item.label}</a>
                </li>
              ))}
            </ul>
          </div>
        </div>
        <div className="border-t border-neutral-900 mb-6"></div>
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            {['Privacy Policy', 'Terms of Service', 'Disclaimer', 'Sitemap'].map((item) => (
              <a key={item} href="#" className="text-neutral-500 hover:text-white text-xs transition-colors duration-300">{item}</a>
            ))}
          </div>
        </div>
      </div>
